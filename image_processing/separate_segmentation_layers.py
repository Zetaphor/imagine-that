...
def separate_segmentation_layers(source_image, mask_image, output_dir, threshold=2):
  """
  ...
  for index, (color, count) in enumerate(colors):
    process_and_extract(source_image, mask_image, color, 1, f'{output_dir}/{filename}_{index + 1}.png')
